...
import { sign_InStart, sign_InSuccess, sign_InFailure } from '../redux/user/userSlice';
...
function Sign_In() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (data.success === false) {
      dispatch(sign_InFailure(data.message));
      return;
    }

    dispatch(sign_InSuccess(data));
    navigate('/');

    } catch(error) {
      dispatch(sign_InFailure(error.message));
